# Проект по автоматизации тестирования сайта Wizardingworld.com

## :crystal_ball:	Содержание
...
### :spider: Локальный запуск тестов

```
gradle clean test
```

### :bat: Удаленный запуск тестов
